...
> We know already what is the NSO. Now it's the time to dirty our hands and check how does it work! <br>
...
### 2nd step - Show onboarded devices:
...
### 4th step - Sync configuration from devices to NSO:
```
