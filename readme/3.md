...
NSO is an Orchestrator - so the main point in the Network that should have knowledge about all of the configuration existing in the connected network devices. 
